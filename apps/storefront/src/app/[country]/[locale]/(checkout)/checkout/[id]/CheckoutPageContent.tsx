    ...
    <div>
      ...
      >
        ...
        <div
          ...
          className="mt-12 border-t border-black/15 pt-7"
        >
        ...
        <button
          ...
          disabled={processing}
          className="relative mt-10 flex h-16 w-full items-center justify-center gap-2 overflow-hidden bg-black text-xs font-semibold uppercase tracking-[0.16em] text-white transition-colors hover:bg-[#d4030a] disabled:cursor-not-allowed disabled:opacity-50"
        >
          <TactileDisc />
          {processing ? (
            <>
