...
export default async function ProductsPage({
  ...
  return (
    <div>
      <DiscoveryMasthead
        eyebrow={query ? "Search index" : "Equipment index"}
        title={query ? query : t("allProducts")}
        description={
          query ? t("searchResultsFor", { query }) : t("browseCollection")
        }
        breadcrumbs={[
          { label: "Home", href: basePath },
          { label: query ? "Search" : t("allProducts") },
        ]}
      />
