...
ActiveRecord::Schema[8.1].define(version: 2026_07_26_173000) do
  ...
  create_table "spree_live_visitor_presences", force: :cascade do |t|
    t.string "city"
    ...
    t.datetime "updated_at", null: false
    t.index ["country_code", "last_seen_at"], name: "idx_on_country_code_last_seen_at_66ef9a2801"
    t.index ["last_seen_at"], name: "index_spree_live_visitor_presences_on_last_seen_at"
    t.index ["session_digest"], name: "index_spree_live_visitor_presences_on_session_digest", unique: true
  end
  ...
  create_table "spree_product_compatibilities", force: :cascade do |t|
    t.boolean "active", default: true, null: false
    t.bigint "compatible_product_id", null: false
    t.datetime "created_at", null: false
    t.integer "position", default: 0, null: false
    t.string "rationale", null: false
    t.string "role", default: "completes_kit", null: false
    t.bigint "source_product_id", null: false
    t.datetime "updated_at", null: false
    t.index ["compatible_product_id"], name: "index_spree_product_compatibilities_on_compatible_product_id"
    t.index ["source_product_id", "compatible_product_id", "role"], name: "idx_spree_product_compatibilities_unique", unique: true
    t.index ["source_product_id"], name: "index_spree_product_compatibilities_on_source_product_id"
  end
  ...
  create_table "spree_product_stories", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.string "eyebrow"
    t.text "introduction"
    t.string "locale", default: "en", null: false
    ...
    t.string "status", default: "draft", null: false
    t.string "theme", default: "whiteout", null: false
    t.string "title", null: false
    t.datetime "updated_at", null: false
    t.index ["product_id", "locale"], name: "index_spree_product_stories_on_product_id_and_locale", unique: true
    t.index ["status", "published_at"], name: "index_spree_product_stories_on_status_and_published_at"
  end

  create_table "spree_product_story_modules", force: :cascade do |t|
    t.string "background_style", default: "surface", null: false
    t.text "body"
    t.jsonb "callouts", default: [], null: false
    t.jsonb "configuration", default: {}, null: false
    t.datetime "created_at", null: false
    t.string "heading"
    t.string "layout"
    t.jsonb "media", default: [], null: false
    t.jsonb "mobile_configuration", default: {}, null: false
    t.string "module_type", null: false
    t.integer "position", default: 0, null: false
    t.jsonb "product_relations", default: [], null: false
    t.bigint "product_story_id", null: false
    t.jsonb "source_references", default: [], null: false
    t.string "subheading"
    t.datetime "updated_at", null: false
    t.string "visibility", default: "visible", null: false
    t.index ["product_story_id", "position"], name: "idx_story_modules_order"
    t.index ["product_story_id"], name: "index_spree_product_story_modules_on_product_story_id"
  end
  ...
  create_table "spree_rider_contributions", force: :cascade do |t|
    ...
    t.index ["line_item_id"], name: "index_spree_rider_contributions_on_line_item_id"
    t.index ["parent_id"], name: "index_spree_rider_contributions_on_parent_id"
    t.index ["product_id", "contribution_type", "status"], name: "index_rider_voices_product_kind"
    t.index ["product_id", "status", "published_at"], name: "index_rider_voices_public_stream"
    t.index ["product_id"], name: "index_spree_rider_contributions_on_product_id"
    t.index ["user_id", "product_id", "contribution_type"], name: "index_rider_voices_author_product"
    t.index ["user_id", "product_id"], name: "index_one_rider_review_per_product", unique: true, where: "((user_id IS NOT NULL) AND ((contribution_type)::text = ANY ((ARRAY['review'::character varying, 'rider_story'::character varying])::text[])) AND (deleted_at IS NULL))"
    t.index ["user_id"], name: "index_spree_rider_contributions_on_user_id"
    t.index ["variant_id"], name: "index_spree_rider_contributions_on_variant_id"
  end

  create_table "spree_rider_helpful_votes", force: :cascade do |t|
    t.bigint "contribution_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["contribution_id", "user_id"], name: "index_rider_votes_uniqueness", unique: true
    t.index ["contribution_id"], name: "index_spree_rider_helpful_votes_on_contribution_id"
    t.index ["user_id"], name: "index_spree_rider_helpful_votes_on_user_id"
  end

  create_table "spree_rider_media", force: :cascade do |t|
    t.string "alt_text"
    t.string "caption"
    t.bigint "contribution_id", null: false
    t.datetime "created_at", null: false
    ...
    t.datetime "updated_at", null: false
    t.integer "width"
    t.index ["contribution_id"], name: "index_spree_rider_media_on_contribution_id"
  end

  create_table "spree_rider_moderation_actions", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.index ["admin_user_id"], name: "index_spree_rider_moderation_actions_on_admin_user_id"
    t.index ["contribution_id"], name: "index_spree_rider_moderation_actions_on_contribution_id"
  end

  create_table "spree_rider_reports", force: :cascade do |t|
    t.bigint "contribution_id", null: false
    t.datetime "created_at", null: false
    t.text "details"
    t.string "reason", null: false
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["contribution_id", "user_id"], name: "index_rider_reports_uniqueness", unique: true
    t.index ["contribution_id"], name: "index_spree_rider_reports_on_contribution_id"
    t.index ["user_id"], name: "index_spree_rider_reports_on_user_id"
  end
  ...
  add_foreign_key "spree_product_compatibilities", "spree_products", column: "compatible_product_id"
  add_foreign_key "spree_product_compatibilities", "spree_products", column: "source_product_id"
  add_foreign_key "spree_product_stories", "spree_products", column: "product_id"
  add_foreign_key "spree_product_story_modules", "spree_product_stories", column: "product_story_id"
  add_foreign_key "spree_product_translations", "spree_products"
  add_foreign_key "spree_rider_contributions", "spree_line_items", column: "line_item_id"
  add_foreign_key "spree_rider_contributions", "spree_products", column: "product_id"
  add_foreign_key "spree_rider_contributions", "spree_rider_contributions", column: "parent_id"
  add_foreign_key "spree_rider_contributions", "spree_users", column: "user_id"
  add_foreign_key "spree_rider_contributions", "spree_variants", column: "variant_id"
  add_foreign_key "spree_rider_helpful_votes", "spree_rider_contributions", column: "contribution_id"
  add_foreign_key "spree_rider_helpful_votes", "spree_users", column: "user_id"
  add_foreign_key "spree_rider_media", "spree_rider_contributions", column: "contribution_id"
  add_foreign_key "spree_rider_moderation_actions", "spree_admin_users", column: "admin_user_id"
  add_foreign_key "spree_rider_moderation_actions", "spree_rider_contributions", column: "contribution_id"
  add_foreign_key "spree_rider_reports", "spree_rider_contributions", column: "contribution_id"
  add_foreign_key "spree_rider_reports", "spree_users", column: "user_id"
