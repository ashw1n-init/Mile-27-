...
Rails.application.configure do
  ...
  # Set host and port for generated Active Storage and mailer links.
  rails_host = ENV.fetch("RAILS_HOST", "localhost:3001")
  host, port = rails_host.split(":")
  port = (port.presence || 3001).to_i
