...
Rails.application.config.after_initialize do
  ...
  # Surface the A+ Product Story editor directly inside the product form.
  Spree.admin.partials.product_form << 'spree/admin/products/product_story'
end
...
Rails.application.config.to_prepare do
  ...
  require_dependency 'spree/product_rider_voices_decorator'
  require_dependency 'spree/product_product_stories_decorator'
  Spree::Product.prepend(Spree::ProductRiderVoicesDecorator) unless Spree::Product < Spree::ProductRiderVoicesDecorator
  Spree::Product.prepend(Spree::ProductProductStoriesDecorator) unless Spree::Product < Spree::ProductProductStoriesDecorator
end
